...
<head>
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-V4FX2E03N2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-V4FX2E03N2');
</script>
<meta charset="utf-8">
...
<link rel="canonical" href="https://www.clauze.ai/terms-of-service">
<link rel="alternate" hreflang="en" href="https://www.clauze.ai/terms-of-service">
<link rel="alternate" hreflang="x-default" href="https://www.clauze.ai/terms-of-service">
<meta property="og:title" content="Terms of Service — Clauze">
<meta property="og:description" content="The agreement governing use of the Clauze platform.">
<meta property="og:type" content="website">
<meta property="og:url" content="https://www.clauze.ai/terms-of-service">
...
<meta name="twitter:title" content="Terms of Service — Clauze">
<meta name="twitter:description" content="The agreement governing use of the Clauze platform.">
...
<div class="pp-wrap" style="position:relative;z-index:1">
  ...
  <div class="pp-body">
    ...
    <ul>
      ...
      <li data-en="Where Customer Content contains personal data, Customer has a lawful basis for processing it and has given any notice required by applicable data protection law;" data-ar="إذا كان محتوى العميل يتضمن بيانات شخصية، فيجب أن يكون لدى العميل أساس قانوني لمعالجتها، وأن يكون قد قدَّم أي إشعار يقتضيه نظام حماية البيانات المعمول به.">Where Customer Content contains personal data, Customer has a lawful basis for processing it and has given any notice required by applicable data protection law;</li>
    ...
    <p data-en="Where Customer provides suggestions, feature requests, or feedback, Clauze may use it without restriction or obligation. Feedback is provided voluntarily and creates no confidentiality obligation, provided it does not contain Customer Content or confidential information." data-ar="في حال قدّم العميل اقتراحات أو طلبات لإضافة ميزات أو ملاحظات، يجوز لكلوز استخدامها دون قيود أو التزامات، ويقدّم العميل هذه الملاحظات طوعًا، ولا يترتب عليها أي التزام بالسرية، شريطة ألا تتضمن محتوى العميل أو أي معلومات سرية.">Where Customer provides suggestions, feature requests, or feedback, Clauze may use it without restriction or obligation. Feedback is provided voluntarily and creates no confidentiality obligation, provided it does not contain Customer Content or confidential information.</p>
    ...
    <p data-en="Neither party may assign or transfer the Agreement without the other's prior written consent, not to be unreasonably withheld, save that either party may assign to an affiliate or to a successor in connection with a merger, acquisition, or sale of substantially all assets, on written notice to the other." data-ar="لا يجوز لأي من الطرفين التنازل عن الاتفاقية أو نقلها دون موافقة الطرف الآخر الخطية المسبقة التي لا تُحجب دون سبب معقول، على أن يجوز لأي من الطرفين التنازل عن الاتفاقية إلى شركة تابعة له أو إلى خلف في إطار اندماج أو استحواذ أو بيع جميع الأصول أو معظمها، بإشعار كتابي للطرف الآخر.">Neither party may assign or transfer the Agreement without the other's prior written consent, not to be unreasonably withheld, save that either party may assign to an affiliate or to a successor in connection with a merger, acquisition, or sale of substantially all assets, on written notice to the other.</p>
