...
<div class="pp-wrap" style="position:relative;z-index:1">
  ...
  <div class="pp-body">
    ...
    <p data-en="A current list of named sub-processors is available on request from <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>. Customers may subscribe to notifications of changes to the sub-processor list and may object to a new sub-processor in accordance with the terms of the applicable Data Processing Agreement." data-ar="تتوافر قائمة محدَّثة بأسماء جهات المعالجة الفرعية عند طلبها من <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>. وللعملاء الاشتراك في إشعارات تغيير القائمة، ولهم الاعتراض على أي جهة معالجة جديدة وفق أحكام اتفاقية معالجة البيانات المنطبقة.">A current list of named sub-processors is available on request from <a href="mailto:privacy@clauze.ai" style="color:#6BB0E0">privacy@clauze.ai</a>. Customers may subscribe to notifications of changes to the sub-processor list and may object to a new sub-processor in accordance with the terms of the applicable Data Processing Agreement.</p>
    ...
    <p data-en="Details of the safeguards applicable to a specific transfer are available on request from <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>." data-ar="وتتوافر تفاصيل الضمانات المنطبقة على أي عملية نقل بعينها عند طلبها من <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>.">Details of the safeguards applicable to a specific transfer are available on request from <a href="mailto:privacy@clauze.ai" style="color:#6BB0E0">privacy@clauze.ai</a>.</p>
    ...
    <p data-en="Submit a request to <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>. We will acknowledge receipt and respond within the period required by applicable law, generally within thirty (30) days, extendable where the request is complex, in which case we will inform you of the extension and the reasons for it." data-ar="يُقدَّم الطلب إلى <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>. وسنُشعِرك باستلامه ونستجيب خلال المدة التي يوجبها النظام المنطبق، وهي ثلاثون (30) يومًا في الغالب، قابلة للتمديد حين يكون الطلب معقدًا، وفي هذه الحالة نُشعرك بالتمديد وأسبابه.">Submit a request to <a href="mailto:privacy@clauze.ai" style="color:#6BB0E0">privacy@clauze.ai</a>. We will acknowledge receipt and respond within the period required by applicable law, generally within thirty (30) days, extendable where the request is complex, in which case we will inform you of the extension and the reasons for it.</p>
    ...
    <p data-en="If we become aware that we have collected personal data from a child, we will delete it promptly. If you believe a child has provided personal data to us, contact <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>." data-ar="وإذا تبيّن لنا أننا جمعنا بيانات شخصية من طفل، أتلفناها على الفور. وإذا كنت تعتقد أن طفلًا زوّدنا ببيانات شخصية، فتواصل معنا على <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>.">If we become aware that we have collected personal data from a child, we will delete it promptly. If you believe a child has provided personal data to us, contact <a href="mailto:privacy@clauze.ai" style="color:#6BB0E0">privacy@clauze.ai</a>.</p>
    ...
    <div class="pp-table-wrap">
      <table class="pp-table">
        <tbody>
          <tr><td data-en="Privacy and security contact" data-ar="التواصل للخصوصية والأمن">Privacy and security contact</td><td><a href="mailto:privacy@clauze.ai" style="color:#6BB0E0">privacy@clauze.ai</a></td></tr>
        </tbody>
      </table>
    </div>

    <h3 data-en="14.2 Complaints" data-ar="14.2 الشكاوى">14.2 Complaints</h3>
    <p data-en="If you are dissatisfied with how we have handled your personal data or your request, please contact us first at <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a> so that we have the opportunity to resolve the matter. We take complaints seriously and will investigate and respond." data-ar="إذا لم ترضك طريقة تعاملنا مع بياناتك الشخصية أو مع طلبك، فنرجو التواصل معنا أولًا على <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a> لتتاح لنا فرصة معالجة الأمر. ونحن نتعامل مع الشكاوى بجدية، ونتولى فحصها والرد عليها.">If you are dissatisfied with how we have handled your personal data or your request, please contact us first at <a href="mailto:privacy@clauze.ai" style="color:#6BB0E0">privacy@clauze.ai</a> so that we have the opportunity to resolve the matter. We take complaints seriously and will investigate and respond.</p>
    ...
    <ul>
      ...
      <li data-en="Previous versions of this Policy are available on request from <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>." data-ar="تتوافر الإصدارات السابقة من هذه السياسة عند طلبها من <a href='mailto:privacy@clauze.ai' style='color:#6BB0E0'>privacy@clauze.ai</a>.">Previous versions of this Policy are available on request from <a href="mailto:privacy@clauze.ai" style="color:#6BB0E0">privacy@clauze.ai</a>.</li>
    </ul>
