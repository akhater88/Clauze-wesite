...
<div class="pp-wrap">
  ...
  <div class="pp-body">
    ...
    <h3 data-en="1.3 Our two roles: Controller and Processor" data-ar="1.3 دوراننا: المتحكم والمعالج">1.3 Our two roles: Controller and Processor</h3>
      ...
      <table class="pp-table">
        ...
        <tbody>
          <tr>
            ...
            <td data-en="Personal data we determine the purposes and means of processing for, account registration data, billing information, website analytics, marketing communications, support interactions, and platform usage telemetry." data-ar="البيانات الشخصية التي نحدّد نحن أغراض معالجتها ووسائلها، كبيانات تسجيل الحساب، وبيانات الفوترة، وتحليلات الموقع، والمراسلات التسويقية، وتفاعلات الدعم، وبيانات استخدام المنصة.">Personal data we determine the purposes and means of processing for, account registration data, billing information, website analytics, marketing communications, support interactions, and platform usage telemetry.</td>
    ...
    <div class="pp-table-wrap">
      <table class="pp-table">
        ...
        <tbody>
          ...
          <tr><td data-en="Legal and regulatory compliance" data-ar="الامتثال النظامي">Legal and regulatory compliance</td><td data-en="Meeting obligations under applicable law, responding to lawful requests from competent authorities, establishing or defending legal claims, and maintaining records required by law." data-ar="الوفاء بالالتزامات المقررة نظامًا، والاستجابة للطلبات المشروعة من الجهات المختصة، وإثبات الحقوق أو الدفاع عنها، وحفظ السجلات التي يوجب النظام حفظها.">Meeting obligations under applicable law, responding to lawful requests from competent authorities, establishing or defending legal claims, and maintaining records required by law.</td></tr>
    ...
    <p data-en="We rely on the following legal bases, depending on the purpose and the applicable regime:" data-ar="نستند في معالجتنا إلى الأسس الآتية بحسب الغرض والنظام المنطبق:">We rely on the following legal bases, depending on the purpose and the applicable regime:</p>
    <div class="pp-table-wrap">
      <table class="pp-table">
        <thead><tr>
    ...
    <p data-en="We may share personal data with our auditors, legal advisers, insurers, and other professional advisers where necessary and subject to obligations of confidentiality. In the event of a merger, acquisition, financing, or sale of assets, personal data may be disclosed to prospective counterparties and their advisers under confidentiality obligations, and may transfer as part of the transaction. We will notify affected Customers of any change of control affecting the processing of their data." data-ar="قد نفصح عن البيانات الشخصية لمراجعي حساباتنا ومستشارينا القانونيين وشركات التأمين وسائر المستشارين المهنيين عند الاقتضاء، وبشرط التزامهم بالسرية. وفي حال الاندماج أو الاستحواذ أو التمويل أو بيع الأصول، قد يُفصح عن البيانات الشخصية للأطراف المحتملة ومستشاريهم بموجب التزامات سرية، وقد تنتقل ضمن الصفقة. وسنُشعِر العملاء المتأثرين بأي تغيير في السيطرة يمس معالجة بياناتهم.">We may share personal data with our auditors, legal advisers, insurers, and other professional advisers where necessary and subject to obligations of confidentiality. In the event of a merger, acquisition, financing, or sale of assets, personal data may be disclosed to prospective counterparties and their advisers under confidentiality obligations, and may transfer as part of the transaction. We will notify affected Customers of any change of control affecting the processing of their data.</p>
    ...
    <div class="pp-table-wrap">
      <table class="pp-table">
        ...
        <tbody>
          ...
          <tr><td data-en="Personnel" data-ar="الموارد البشرية">Personnel</td><td data-en="Background screening where lawful, confidentiality undertakings, mandatory security and data protection training, and prompt access revocation on role change or departure." data-ar="التحقق من الخلفية حيث يجيزه النظام، وتعهدات السرية، والتدريب الإلزامي على الأمن وحماية البيانات، وإلغاء الصلاحيات فور تغيّر الدور أو انتهاء العلاقة.">Background screening where lawful, confidentiality undertakings, mandatory security and data protection training, and prompt access revocation on role change or departure.</td></tr>
    ...
    <ul>
      ...
      <li data-en="Where Clauze acts as a Processor, we will notify the affected Customer without undue delay after becoming aware, and provide the information reasonably required for that Customer to meet its own notification obligations." data-ar="وحين تعمل كلوز بصفة جهة معالجة، نُشعِر العميل المتأثر دون تأخير غير مبرر بعد علمنا، ونزوّده بالمعلومات اللازمة للوفاء بالتزاماته الخاصة بالإبلاغ.">Where Clauze acts as a Processor, we will notify the affected Customer without undue delay after becoming aware, and provide the information reasonably required for that Customer to meet its own notification obligations.</li>
      <li data-en="Where the breach is likely to result in a high risk to the rights and freedoms of individuals, affected individuals will be notified in accordance with applicable law." data-ar="وإذا كان من شأن التسرب أن يُلحق ضررًا جسيمًا بحقوق أصحاب البيانات، نُشعِر المتأثرين وفق ما يوجبه النظام.">Where the breach is likely to result in a high risk to the rights and freedoms of individuals, affected individuals will be notified in accordance with applicable law.</li>
    </ul>
    <p data-en="No security measure is absolute. While we work continuously to protect personal data, we cannot guarantee that unauthorised access will never occur." data-ar="ولا يوجد تدبير أمني مطلق. وبينما نعمل باستمرار على حماية البيانات الشخصية، لا يمكننا ضمان استحالة وقوع وصول غير مصرح به.">No security measure is absolute. While we work continuously to protect personal data, we cannot guarantee that unauthorised access will never occur.</p>
    ...
    <div class="pp-table-wrap">
      <table class="pp-table">
        ...
        <tbody>
          <tr><td data-en="Customer Content" data-ar="محتوى العميل">Customer Content</td><td data-en="For the duration of the subscription, plus the post-termination export window specified in the subscription agreement. Deleted thereafter in accordance with the Customer&rsquo;s instructions." data-ar="طوال مدة الاشتراك، مضافًا إليها فترة التصدير بعد الإنهاء المنصوص عليها في اتفاقية الاشتراك. ثم يُتلَف وفق تعليمات العميل.">For the duration of the subscription, plus the post-termination export window specified in the subscription agreement. Deleted thereafter in accordance with the Customer's instructions.</td><td data-en="Contract" data-ar="تنفيذ عقد">Contract</td></tr>
          <tr><td data-en="Account and identity data" data-ar="بيانات الحساب والهوية">Account and identity data</td><td data-en="For the duration of the account, plus up to twenty-four (24) months after closure." data-ar="طوال مدة الحساب، مضافًا إليها مدة لا تتجاوز أربعة وعشرين (24) شهرًا بعد إغلاقه.">For the duration of the account, plus up to twenty-four (24) months after closure.</td><td data-en="Contract and legitimate interests" data-ar="تنفيذ عقد ومصلحة مشروعة">Contract and legitimate interests</td></tr>
    ...
    <div class="pp-table-wrap">
      <table class="pp-table">
        ...
        <tbody>
          <tr><td data-en="Strictly necessary" data-ar="ضرورية بحتًا">Strictly necessary</td><td data-en="Authentication, session management, security, load balancing, and preserving your preferences. The service cannot function without these." data-ar="المصادقة، وإدارة الجلسة، والأمن، وموازنة الأحمال، وحفظ تفضيلاتك. ولا تعمل الخدمة بدونها.">Authentication, session management, security, load balancing, and preserving your preferences. The service cannot function without these.</td><td data-en="No, exempt" data-ar="لا، معفاة">No, exempt</td></tr>
    ...
    <ul>
      ...
      <li data-en="Data subjects may lodge a complaint with SDAIA. Contact details are published at sdaia.gov.sa." data-ar="ولأصحاب البيانات التقدم بشكوى إلى سدايا، وبيانات التواصل منشورة على sdaia.gov.sa.">Data subjects may lodge a complaint with SDAIA. Contact details are published at sdaia.gov.sa.</li>
    </ul>
