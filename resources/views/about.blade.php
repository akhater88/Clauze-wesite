  ...
  <section class="about-hero">
    ...
    <div class="about-hero-inner">
      <div class="about-hero-content">
        ...
        <p class="about-subtitle" data-en="We believe the next generation of legal technology should do more than review documents or answer legal questions. It should understand the organization behind them." data-ar="نؤمن بأن الجيل القادم من التقنية القانونية يجب أن يتجاوز مراجعة المستندات أو الإجابة على الأسئلة القانونية، ويجب أن يفهم المنظّمة التي تقف خلفها.">We believe the next generation of legal technology should do more than review documents or answer legal questions. It should understand the organization behind them.</p>
      </div>
    </div>
  </section>
  ...
  <section class="about-founder-section">
    <div class="about-founder-grid">
      <div class="about-founder-img-wrap reveal-left">
        <img class="about-founder-img" src="/assets/founder-waad.jpg?v=1.32235" alt="Waad Alkurini, Founder of Clauze" loading="eager">
      </div>
