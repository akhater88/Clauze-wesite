...
<link rel="alternate" hreflang="en" href="https://www.clauze.ai/" />
<link rel="alternate" hreflang="x-default" href="https://www.clauze.ai/" />
  ...
  "@graph": [
    {
      ...
      "logo": "https://www.clauze.ai/assets/logo-clauze.png",
      "description": "The first Arabic-native AI legal workspace and virtual data room built for Saudi Arabia.",
      "sameAs": ["https://www.linkedin.com/company/clauze-ai", "https://x.com/clauze_ai"]
    },
    {
...
<div style="overflow-x:clip;background:#26235A">
  ...
  <section id="top" style="position:relative;display:flex;align-items:center;min-height:min(88vh,900px);overflow:hidden;background:#26235A">
    <div ref="{{ heroArtRef }}" style="position:absolute;bottom:36px;inset-inline-end:0;width:min(100%);height:100%">
      <img ref="{{ heroPhotoRef }}" src="assets/hero-header-02.png" alt="Legal professional reviewing contracts on the Clauze AI platform" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;object-position:100% center"/>
...
class Component extends DCLogic {
  ...
  componentDidMount() {
    ...
    this.onScroll = () => { this.layoutNavBar(); if (this.menuOpen) this.toggleMenu(); };
